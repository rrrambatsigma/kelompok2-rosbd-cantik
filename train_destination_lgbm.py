...
encoder_path = os.path.join(MODEL_DIR, "destination_encoder_lgbm.pkl")
...
model_path = os.path.join(MODEL_DIR, "destination_lgbm.pkl")
...
for idx in sample_idx:
    ...
    correct += is_correct
    print(f"\n{'V' if is_correct else 'X'} True: {true_dest}")
